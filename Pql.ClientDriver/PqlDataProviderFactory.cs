...
namespace Pql.ClientDriver
{
    ...
    public sealed class PqlDataProviderFactory : DbProviderFactory
    {
        ...
        /// </summary>
        public static readonly PqlDataProviderFactory Instance = new();
        ...
        public override DbCommand CreateCommand() => new PqlDataCommand(null);
        ...
        /// </returns>
        /// <filterpriority>2</filterpriority>
        public override DbConnection CreateConnection() => new PqlDataConnection();
        ...
        /// </returns>
        /// <filterpriority>2</filterpriority>
        public override DbParameter CreateParameter() => new PqlDataCommandParameter();
    }
}
