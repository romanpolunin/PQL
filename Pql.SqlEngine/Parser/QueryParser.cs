...
namespace Pql.SqlEngine.DataContainer.Parser
{
    ...
    public class PqlCompilerState : CompilerState
    {
        ...
        {
            ParsedRequest = parsedRequest ?? throw new ArgumentNullException(nameof(parsedRequest));
            RequestParameters = requestParams ?? throw new ArgumentNullException(nameof(requestParams));
