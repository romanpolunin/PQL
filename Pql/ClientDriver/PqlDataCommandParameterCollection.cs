...
namespace Pql.ClientDriver
{
    ...
    public class PqlDataCommandParameterCollection : DbParameterCollection, IDataParameterCollection
    {
        ...
        private readonly List<PqlDataCommandParameter> m_parameters;
        ...
        public PqlDataCommandParameterCollection()
        {
            ...
            m_parameters = new List<PqlDataCommandParameter>();
        }

        /// <summary>
        /// Internal direct access to typed parameters information.
        /// </summary>
        internal IReadOnlyList<PqlDataCommandParameter> ParametersData { get { return m_parameters; } }
        ...
        public override void CopyTo(Array array, int index)
        {
            ...
            if (index < 0)
            {
                throw new ArgumentOutOfRangeException("index", index, "Index may not be negative");
            }

            if (array.Rank != 1 || array.Length < m_parameters.Count + index)
            {
            ...
            {
                array.SetValue(m_parameters[i], i + index);
            }
        }
        ...
        /// </returns>
        /// <filterpriority>2</filterpriority>
        public override int Count { get { return m_parameters.Count; } }
        ...
        /// </returns>
        /// <filterpriority>2</filterpriority>
        public override object SyncRoot { get { return m_thisLock; } }
        ...
        {
            return m_parameters.Contains(EnsureImplementationType(value));
        }
        ...
        {
            return m_parameters.IndexOf(EnsureImplementationType(value));
        }
        ...
        {
            m_parameters.Insert(index, EnsureImplementationType(value));
        }
        ...
        {
            m_parameters.Remove(EnsureImplementationType(value));
        }
        ...
        object IList.this[int index]
        {
            ...
            set { m_parameters[index] = EnsureImplementationType(value); }
        }
