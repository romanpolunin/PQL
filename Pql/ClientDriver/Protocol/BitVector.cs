...
namespace Pql.ClientDriver.Protocol
{
    ...
    public static class BitVector
    {
        ...
        public static bool Get(int[] bits, int index)
        {
            return (bits[index / BitsPerInt32] & 1 << index % BitsPerInt32) != 0;
        }
        ...
        {
            bits[index / BitsPerInt32] |= 1 << index % BitsPerInt32;
        }
        ...
        /// <returns></returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Int32 GetArrayLength(Int32 n)
        {
            return n <= 0 ? 0 : (n - 1) / BitsPerInt32 + 1;
        }
        ...
        public static void Write(int[] bits, int count, BinaryWriter writer)
        {
            ...
            {
                throw new ArgumentOutOfRangeException("count", count, "Count of bits does not match size of the bitvector data array");
            }
        ...
        {
            return 0 == size % 8 ? size / 8 : 1 + size / 8;
        }
    }
}