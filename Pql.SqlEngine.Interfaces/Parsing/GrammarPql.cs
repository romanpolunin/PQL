...
namespace Pql.Engine.Interfaces.Parsing
{
    ...
    public class GrammarPql : Irony.Parsing.Grammar
    {
        ...
        { //SQL is case insensitive
            ...
            binOp.Rule = ToTerm("+") | "-" | "*" | "/" | "%" //arithmetic
                        | "&" | "|" | "^"                     //bit
                        | "=" | ">" | "<" | ">=" | "<=" | "<>" | "!=" | "!<" | "!>"
                        | "AND" | "OR" | "XOR" | "LIKE" | NOT + "LIKE" | "IN" | NOT + "IN";
