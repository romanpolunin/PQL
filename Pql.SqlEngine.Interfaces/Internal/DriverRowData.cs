...
namespace Pql.SqlEngine.Interfaces.Internal
{
    ...
    public sealed class DriverRowData
    {
        ...
        public DriverRowData(DbType[] fieldTypes)
        {
            ...
            count = _fieldCountsByStorageType[(int)DataTypeRepresentation.String];
        ...
        public SizableArrayOfByte GetBinary(int indexInResponse) => BitVector.Get(NotNulls, indexInResponse) ? BinaryData[FieldArrayIndexes[indexInResponse]] : null;
        ...
        public decimal GetCurrency(int indexInResponse) => BitVector.Get(NotNulls, indexInResponse) ? ValueData16Bytes[FieldArrayIndexes[indexInResponse]].AsDecimal : 0;
        ...
        private static Expression CreateWriteAccessor(Expression value, Expression rowData, string valueArrayName, int ordinalValue, DbType dbType, string subFieldName)
        {
            ...
            // null values of reference types simply take value of null
            if (dbType is DbType.Object or DbType.Binary)
            {
        ...
        public static DataTypeRepresentation DeriveRepresentationType(DbType dbType) => s_fieldStorage[dbType];
    }
}